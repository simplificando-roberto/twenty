...
export enum FeatureFlagKey {
  ...
  IS_EMAIL_CAMPAIGN_TRIAL_SENDING_ENABLED = 'IS_EMAIL_CAMPAIGN_TRIAL_SENDING_ENABLED',
...
export type MutationUpdateWorkspaceMessageCampaignDailySendLimitArgs = {
...
export type UpdateWorkspaceMessageCampaignDailySendLimitMutationVariables = Exact<{
  workspaceId: Scalars['UUID']['input'];
  dailySendLimit?: InputMaybe<Scalars['Int']['input']>;
}>;


export type UpdateWorkspaceMessageCampaignDailySendLimitMutation = { __typename?: 'Mutation', updateWorkspaceMessageCampaignDailySendLimit: boolean };
...
export type UserLookupAdminPanelQuery = { __typename?: 'Query', userLookupAdminPanel: { __typename?: 'UserLookup', user?: { __typename?: 'UserInfo', id: string, email: string, firstName?: string | null, lastName?: string | null, createdAt: string } | null, workspaces: Array<{ __typename?: 'WorkspaceInfo', id: string, name: string, logo?: string | null, totalUsers: number, activationStatus: WorkspaceActivationStatus, createdAt: string, allowImpersonation: boolean, messageCampaignDailySendLimit?: number | null, workspaceUrls: { __typename?: 'WorkspaceUrls', customUrl?: string | null, subdomainUrl: string }, users: Array<{ __typename?: 'UserInfo', id: string, email: string, firstName?: string | null, lastName?: string | null }>, featureFlags: Array<{ __typename?: 'FeatureFlag', key: FeatureFlagKey, value: boolean }> }> } };
...
export type WorkspaceLookupAdminPanelQuery = { __typename?: 'Query', workspaceLookupAdminPanel: { __typename?: 'UserLookup', user?: { __typename?: 'UserInfo', id: string, email: string, firstName?: string | null, lastName?: string | null, createdAt: string } | null, workspaces: Array<{ __typename?: 'WorkspaceInfo', id: string, name: string, allowImpersonation: boolean, logo?: string | null, totalUsers: number, activationStatus: WorkspaceActivationStatus, createdAt: string, messageCampaignDailySendLimit?: number | null, workspaceUrls: { __typename?: 'WorkspaceUrls', customUrl?: string | null, subdomainUrl: string }, users: Array<{ __typename?: 'UserInfo', id: string, email: string, firstName?: string | null, lastName?: string | null, avatarUrl?: string | null }>, featureFlags: Array<{ __typename?: 'FeatureFlag', key: FeatureFlagKey, value: boolean }> }> } };
...
export const UpdateWorkspaceMessageCampaignDailySendLimitDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateWorkspaceMessageCampaignDailySendLimit"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workspaceId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"dailySendLimit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateWorkspaceMessageCampaignDailySendLimit"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"workspaceId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workspaceId"}}},{"kind":"Argument","name":{"kind":"Name","value":"dailySendLimit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"dailySendLimit"}}}]}]}}]} as unknown as DocumentNode<UpdateWorkspaceMessageCampaignDailySendLimitMutation, UpdateWorkspaceMessageCampaignDailySendLimitMutationVariables>;
